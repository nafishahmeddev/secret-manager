...
export default function ProjectFormPage() {
  ...
  return (
    <div >
      <div className="w-full  bg-white rounded-xl shadow-md border border-[#dddfe2] p-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-2xl font-bold text-primary-600 tracking-tight">{projectId ? "Edit Project" : "New Project"}</h1>
